...
def creer_evaluation():
    ...
    with tab1:
        ...
        with col1:
            ...
            evaluation_date = st.date_input("Date de l'Évaluation", date.today())
        with col2:
        ...
        date_premier_suivi = st.date_input("Date du Premier Suivi")
        date_deuxieme_suivi = st.date_input("Date du Deuxième Suivi")
        date_troisieme_suivi = st.date_input("Date du Troisième Suivi")
        ...
        if st.button("Soumettre Évaluation", key = "soumettre_evaluation_tab1"):
    ...
    with tab2:
        ...
        if st.button("Soumettre Évaluation", key = "submit_evaluation_tab2"):
            id_evaluation_technique = queries.ajouter_evaluation_technique(id_joueur,evaluation_date, qualite_premiere_touche,
                qualite_passes, technique_defensive, sens_tactique_vision, vitesse_pensee,
                anticipation, adaptation_adversaire, sens_replacement, sens_demarquage, sens_marquage,
                technique_generale, jeu_tete, puissance_frappe, drible_feinte,
